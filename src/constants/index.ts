...
export const ABOUT = `## About Congreat
Founded to grant control over our most valuable asset—our home. We are committed to driving efficiency, reducing costs, and empowering technology in a traditional industry.

## Congreat Vision
Optimizing productivity in a traditional industry through rapid, data-driven decisions that minimize delays and reduce costs.

## Congreat Vision
Granting full control of the construction process to anyone, anywhere.
`;

export const SOLUTIONS = `## Congreat Solution for
Granting full control of the construction process to anyone, anywhere.

### Real Estate Developers
Congreat provides full project oversight, helping you streamline operations, reduce costs, and ensure timely delivery of your developments.

### Construction Company Managers
Congreat enables you to manage multiple projects efficiently, optimize resources, and improve coordination across teams for smoother operations.

### Project Managers and Foremen
With Congreat, you can track progress in real time, manage tasks, and ensure your team stays on schedule while minimizing delays and costs.
